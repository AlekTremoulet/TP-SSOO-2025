...
/*nuevas*/
    ...
    OP_FLUSH,
    OP_DELETE,
    ERR_ESCRITURA_ARCHIVO_COMMITED,
    ERR_FILE_PREEXISTENTE,
    ERR_TAG_PREEXISTENTE,
    ERR_LECTURA_FUERA_DEL_LIMITE,
    ERR_TAG_INEXISTENTE,
    ERR_FILE_INEXISTENTE,
    ERR_ESPACIO_INSUFICIENTE,
    ERR_METADATA,
    ERR_ESCRITURA_BLOQUE,
    ERR_FORBIDDEN,
/*nuevas*/
    NOMBRE_IO,
    DORMIR_IO,
